        ...
        <div className="py-10 lg:pl-12">
          ...
          <Section title="What it is">
            <div className="max-w-xl space-y-4 font-serif text-base leading-relaxed text-text">
              <p>
                ...
                in-plane pull, so a layout of any size behaves as a single rigid
                body rather than a set of pieces that creep apart under a tugged
                cable.
              </p>
              <p>
                Carrier inserts drop into a tile to hold a board or a tray. Caps
                close the free male and female dovetails around the perimeter,
                so a finished cluster has no exposed joint. Half tiles let a
                layout end on a straight edge instead of a saw-tooth.
              </p>
            </div>
          </Section>
          ...
          <Section title="Geometry">
            ...
            <p className="mt-6 max-w-xl font-serif text-sm leading-relaxed text-muted">
              The pitch beside this is the hex across-flats dimension plus that
              gap: a 43.85 mm circumradius gives 75.95 mm across flats, and the
              0.25 mm clearance takes it to {PITCH}, which is 3.00 in. Design to
              the pitch if you are adapting the standard; design to the gap if
              you are printing it.
            </p>
          </Section>
          ...
          <Section title="Print spec">
            ...
            <p className="mt-6 max-w-xl font-serif text-sm leading-relaxed text-muted">
              Verify XY tolerance with a printed test cube before committing to
              a full set. At this clearance per-printer calibration is likely:
              if parts do not engage cleanly, measure shrinkage and re-slice
              with compensation rather than sanding the joints.
            </p>
                ...
                <li key={f.name} className="border-b border-panel-border/60">
                  ...
                  >
                    <span className="flex items-baseline gap-3">
                      <span aria-hidden="true" className="font-mono text-command-gold">
                        ↓
                      </span>
          ...
          <Section title="License and attribution">
            <div className="max-w-xl space-y-4 font-serif text-base leading-relaxed text-text">
              ...
              <p>
                You can do that however suits your platform. This line is ready
                to paste:
              </p>
            </div>
            ...
            <p className="mt-5 max-w-xl font-serif text-sm leading-relaxed text-muted">
              ...
              . CC BY runs one way: files already published under it stay under
              it, and only a future release could carry different terms.
            </p>
          </Section>
