...
const part = { id: "p1", mpn: "RT9080-33GJ5", manufacturer: "Richtek", description: "LDO", category: "LDO_REGULATOR" as const, categoryRef: null, lifecycle: "ACTIVE" as const, isCertifiedModule: false, dkStockQty: null, dkInStock: null, dkLifecycle: null, dkCheckedAt: null };
