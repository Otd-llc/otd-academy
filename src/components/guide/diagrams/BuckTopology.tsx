...
.bk-blk{fill:var(--color-diagram-surface,#1f2438);stroke:var(--color-command-gold,#c8963e);stroke-width:2;}
...
@container (max-width:520px){ .bk-scene{display:none;} .bk-list{display:flex;} }
