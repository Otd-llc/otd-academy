...
.ph-glass{fill:var(--color-diagram-surface,#1f2438);stroke:var(--color-panel-border,#3a3f50);stroke-width:1.5;}
...
@container (max-width:520px){ .ph-scene{display:none;} .ph-list{display:flex;} }
