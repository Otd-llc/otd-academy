...
export function WroomU1({ x = 0, y = 0, scale = 1 }: { x?: number; y?: number; scale?: number }) {
  return (
    <g transform={`translate(${x},${y}) scale(${scale})`}>
      {/* square module body */}
      <rect x="0" y="30" width="100" height="100" rx="4" fill="#1f2438" stroke="#c8963e" strokeWidth="2.5" />
      {/* antenna section — FULL module width, on top, overhangs the board edge */}
      <rect x="0" y="0" width="100" height="30" rx="2" fill="#1f2438" stroke="#c8963e" strokeWidth="2.5" />
      ...
      <path d="M10 26 V11 H22 V26 H34 V11 H46 V26 H58 V11 H70 V26 H82 V11 H90 V26"
        fill="none" stroke="#ffffff" strokeWidth="2.5" strokeLinejoin="miter" />
      ...
      <text x="50" y="89" textAnchor="middle" fill="#ffffff" fontFamily="'Space Mono',monospace" fontSize="22" fontWeight="700">U1</text>
    </g>
  );
}
