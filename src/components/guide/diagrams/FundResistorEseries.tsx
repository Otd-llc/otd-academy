...
@container (max-width:520px){ .re-scene{display:none;} .re-list{display:flex;} }
...
@container (max-width:520px){ .re-note{display:block;} }
@container (min-width:521px){ .re-note{display:none;} }
