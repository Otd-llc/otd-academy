...
.ld-blk{fill:var(--color-navy-dark,#1a1a2e);stroke:var(--color-panel-border,#3a3f50);stroke-width:2;}
...
@media (max-width:520px){ .ld-scene{display:none;} .ld-list{display:flex;} }
