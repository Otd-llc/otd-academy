...
export function ChecklistItemLabelCell({
  ...
  return (
    <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
      ...
      {notApplicable ? (
        <span className="inline-block rounded border border-command-gold bg-deep-space px-1.5 py-0.5 font-mono text-[10px] font-bold uppercase tracking-wider text-command-gold">
          N/A
        </span>
      ) : null}
    </div>
