// l1-05-internal-adc: materialize the DESIGN_VALIDATION checklist + write the BOM
...
//   LOCAL: pnpm exec tsx scripts/build-l105-revision-bom.ts
//   PROD:  pnpm db:prod scripts/build-l105-revision-bom.ts
import { config as loadEnv } from "dotenv";
loadEnv({ path: ".env.local" }); // LOCAL foundry_dev
import { readFileSync } from "node:fs";

const PROJECT_SLUG = "l1-05-internal-adc";
const CSV_PATH = "docs/boards/l1-05-internal-adc/bom.csv";
